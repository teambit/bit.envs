/**
 * # A testing environment for React components using Jest 15.1.1.
 * Bit testing environment for testing of React components using Jest 15.1.1.
 *
 * ## How to use?
 * import the environment
 * ```bash
 * bit import bit.envs/testers/jest-15 -t
 * ```
 *
 * ## What's inside?
